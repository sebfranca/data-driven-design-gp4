...
working_dir = 'C:/Users/cedri/OneDrive/Documents/Mécanique - EPFL/Master IV/Data-driven-design-and-fabrication-methods/Abaqus_results/'
filename = 'beam_example'

setPath = os.path.join(working_dir, 
                       filename)
...
try:
    beamEx()
    LOG("Job successfully processed")
except:
    LOG('Job failed to launch')
    
parser_res(jobName)

#log('Last iteration result : %.4f'%(res_max))
